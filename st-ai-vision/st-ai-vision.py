...
# /IOTCONNECT Greengrass SDK imports
...
class Application:
    ...
    def iotconnect_main(self):
        try:
            ...
            print("Failed to initialize the SDK", ce)
            print("SDK is not available. Running in test mode")

        # we can reschedule with a different timeout value in the future, perhaps with a C2D command
        self.telemetry_periodic_timer = GLib.timeout_add(1000, self.iotconnect_send_telemetry_periodic_timer)
